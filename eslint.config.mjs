...
export default [
  ...
  // Специфическая настройка для файлов с CommonJS
  {
    ...
    rules: {
      "node/no-unsupported-features/es-syntax": "off", // Отключаем ошибку для старого синтаксиса
      "linebreak-style": ["error", "unix"], // Принудительно указываем стиль перевода строки
    },
  },
  // Специфическая настройка для React файлов
  {
    files: ["**/*.jsx"],
    languageOptions: {
      globals: globals.browser, // Только для React файлов
    },
  },
